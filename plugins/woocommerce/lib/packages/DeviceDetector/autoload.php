...
/**
 * PSR-4 autoloader implementation for the Automattic\WooCommerce\Vendor\DeviceDetector namespace.
...
{
    if (false === strpos($class, 'Automattic\WooCommerce\Vendor\DeviceDetector\\')) {
        return;
    }

    $namespaceMap = ['Automattic\WooCommerce\Vendor\DeviceDetector\\' => __DIR__ . '/'];
